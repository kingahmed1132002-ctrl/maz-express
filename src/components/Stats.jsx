...
const Stats = ({ fadeInUp, bgColor = '#f0f8fc' }) => {
  ...
  const STATS = [
    { val: '+5,000', label: t.stat_1_label,      icon: '📦' },
    { val: '1,500+', label: t.stat_2_label,       icon: '🚀' },
    { val: '0%',     label: t.stat_3_label, icon: '🎯' },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-5 relative z-10 text-center">
        ...
        >
          {t.stats_title}{' '}
          <span style={{ color: '#36C6F4' }}>{t.stats_title_accent}</span>
        </motion.h2>
